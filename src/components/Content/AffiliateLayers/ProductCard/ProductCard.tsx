...
function ProductCard({
  ...
  return (
    ...
    >
      ...
      {!hideSticker && <div className='product-card__badges-list'>
        <div className={window.location.pathname.toLowerCase().includes("proizvodi") ? 'product-card__badge product-card__badge--new':'product-card__badge product-card__badge--hot'}>{window.location.pathname.toLowerCase().includes("proizvodi") ? "NOVO" : "NAJPRODAVANIJI"}</div>
        </div>
      }
